...
Revision ID: d88cd3b93f40
Revises: 
Create Date: 2024-01-19 09:29:31.305678
...
def upgrade():
    ...
    sa.Column('valoracion', sa.Boolean(), nullable=False),
    sa.Column('id_usuario', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_usuario'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id_carrocompra', sa.Integer(), nullable=False),
    sa.Column('hora', sa.TIMESTAMP(), nullable=False),
    sa.ForeignKeyConstraint(['id_carrocompra'], ['carrocompra.id'], ),
