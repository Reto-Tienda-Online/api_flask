INSERT INTO categorias (categoria, descripcion) VALUES
    ('Aventura', 'Videojuegos centrados en la narrativa y la exploración'),
    ('Acción', 'Juegos con énfasis en el combate y la acción frenética'),
    ('Estrategia', 'Juegos que requieren planificación y toma de decisiones estratégicas'),
    ('RPG', 'Juegos de rol con historias extensas y desarrollo de personajes'),
